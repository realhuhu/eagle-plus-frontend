  ...
  <div>
    ...
    <div class="md:flex justify-between items-start gap-6">
      <a-form-item label="用户" class="w-auto md:w-[50%]">
        <a-input v-model:model-value="interaction_params.uid" placeholder="请输入完整uid" allow-clear/>
      </a-form-item>

      <a-form-item label="搜索" class="w-auto md:w-[50%]">
        <a-input placeholder="请输入搜索内容" v-model:model-value="interaction_params.search" :disabled="search_disable"
                 allow-clear/>
      </a-form-item>
    </div>
    ...
    <div class="md:flex justify-between items-start gap-6">
      <a-form-item label="舰长" class="w-auto md:w-[50%]">
        <a-select v-model="interaction_params.guard" placeholder="请选择..." multiple>
      ...
      <a-form-item label="排序" class="w-auto md:w-[50%]">
        <a-select placeholder="请选择" v-model="interaction_params.ordering">
